...
public class FileFunctions {
    ...
    public static void main(String... args) throws Exception {
        ...
        stat.execute("CREATE ALIAS READ_TEXT_FILE " +
                "FOR \"org.h14199.samples.FileFunctions.readTextFile\" ");
        stat.execute("CREATE ALIAS READ_TEXT_FILE_WITH_ENCODING " +
                "FOR \"org.h14199.samples.FileFunctions.readTextFileWithEncoding\" ");
        stat.execute("CREATE ALIAS READ_FILE " +
                "FOR \"org.h14199.samples.FileFunctions.readFile\" ");
