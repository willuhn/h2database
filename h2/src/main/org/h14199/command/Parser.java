 ...
 */
package org.h14199.command;

import static org.h14199.util.ParserUtil.ALL;
import static org.h14199.util.ParserUtil.ARRAY;
import static org.h14199.util.ParserUtil.CASE;
import static org.h14199.util.ParserUtil.CHECK;
import static org.h14199.util.ParserUtil.CONSTRAINT;
import static org.h14199.util.ParserUtil.CROSS;
import static org.h14199.util.ParserUtil.CURRENT_DATE;
import static org.h14199.util.ParserUtil.CURRENT_TIME;
import static org.h14199.util.ParserUtil.CURRENT_TIMESTAMP;
import static org.h14199.util.ParserUtil.CURRENT_USER;
import static org.h14199.util.ParserUtil.DISTINCT;
import static org.h14199.util.ParserUtil.EXCEPT;
import static org.h14199.util.ParserUtil.EXISTS;
import static org.h14199.util.ParserUtil.FALSE;
import static org.h14199.util.ParserUtil.FETCH;
import static org.h14199.util.ParserUtil.FOR;
import static org.h14199.util.ParserUtil.FOREIGN;
import static org.h14199.util.ParserUtil.FROM;
import static org.h14199.util.ParserUtil.FULL;
import static org.h14199.util.ParserUtil.GROUP;
import static org.h14199.util.ParserUtil.HAVING;
import static org.h14199.util.ParserUtil.IDENTIFIER;
import static org.h14199.util.ParserUtil.IF;
import static org.h14199.util.ParserUtil.INNER;
import static org.h14199.util.ParserUtil.INTERSECT;
import static org.h14199.util.ParserUtil.INTERSECTS;
import static org.h14199.util.ParserUtil.INTERVAL;
import static org.h14199.util.ParserUtil.IS;
import static org.h14199.util.ParserUtil.JOIN;
import static org.h14199.util.ParserUtil.LIKE;
import static org.h14199.util.ParserUtil.LIMIT;
import static org.h14199.util.ParserUtil.LOCALTIME;
import static org.h14199.util.ParserUtil.LOCALTIMESTAMP;
import static org.h14199.util.ParserUtil.MINUS;
import static org.h14199.util.ParserUtil.NATURAL;
import static org.h14199.util.ParserUtil.NOT;
import static org.h14199.util.ParserUtil.NULL;
import static org.h14199.util.ParserUtil.OFFSET;
import static org.h14199.util.ParserUtil.ON;
import static org.h14199.util.ParserUtil.ORDER;
import static org.h14199.util.ParserUtil.PRIMARY;
import static org.h14199.util.ParserUtil.QUALIFY;
import static org.h14199.util.ParserUtil.ROW;
import static org.h14199.util.ParserUtil.ROWNUM;
import static org.h14199.util.ParserUtil.SELECT;
import static org.h14199.util.ParserUtil.TABLE;
import static org.h14199.util.ParserUtil.TRUE;
import static org.h14199.util.ParserUtil.UNION;
import static org.h14199.util.ParserUtil.UNIQUE;
import static org.h14199.util.ParserUtil.VALUES;
import static org.h14199.util.ParserUtil.WHERE;
import static org.h14199.util.ParserUtil.WINDOW;
import static org.h14199.util.ParserUtil.WITH;
import static org.h14199.util.ParserUtil._ROWID_;
...
import org.h14199.command.ddl.AlterIndexRename;
import org.h14199.command.ddl.AlterSchemaRename;
import org.h14199.command.ddl.AlterSequence;
import org.h14199.command.ddl.AlterTableAddConstraint;
import org.h14199.command.ddl.AlterTableAlterColumn;
import org.h14199.command.ddl.AlterTableDropConstraint;
import org.h14199.command.ddl.AlterTableRename;
import org.h14199.command.ddl.AlterTableRenameColumn;
import org.h14199.command.ddl.AlterTableRenameConstraint;
import org.h14199.command.ddl.AlterUser;
import org.h14199.command.ddl.AlterView;
import org.h14199.command.ddl.Analyze;
import org.h14199.command.ddl.CommandWithColumns;
import org.h14199.command.ddl.CreateAggregate;
import org.h14199.command.ddl.CreateConstant;
import org.h14199.command.ddl.CreateDomain;
import org.h14199.command.ddl.CreateFunctionAlias;
import org.h14199.command.ddl.CreateIndex;
import org.h14199.command.ddl.CreateLinkedTable;
import org.h14199.command.ddl.CreateRole;
import org.h14199.command.ddl.CreateSchema;
import org.h14199.command.ddl.CreateSequence;
import org.h14199.command.ddl.CreateSynonym;
import org.h14199.command.ddl.CreateTable;
import org.h14199.command.ddl.CreateTrigger;
import org.h14199.command.ddl.CreateUser;
import org.h14199.command.ddl.CreateView;
import org.h14199.command.ddl.DeallocateProcedure;
import org.h14199.command.ddl.DefineCommand;
import org.h14199.command.ddl.DropAggregate;
import org.h14199.command.ddl.DropConstant;
import org.h14199.command.ddl.DropDatabase;
import org.h14199.command.ddl.DropDomain;
import org.h14199.command.ddl.DropFunctionAlias;
import org.h14199.command.ddl.DropIndex;
import org.h14199.command.ddl.DropRole;
import org.h14199.command.ddl.DropSchema;
import org.h14199.command.ddl.DropSequence;
import org.h14199.command.ddl.DropSynonym;
import org.h14199.command.ddl.DropTable;
import org.h14199.command.ddl.DropTrigger;
import org.h14199.command.ddl.DropUser;
import org.h14199.command.ddl.DropView;
import org.h14199.command.ddl.GrantRevoke;
import org.h14199.command.ddl.PrepareProcedure;
import org.h14199.command.ddl.SchemaCommand;
import org.h14199.command.ddl.SequenceOptions;
import org.h14199.command.ddl.SetComment;
import org.h14199.command.ddl.TruncateTable;
import org.h14199.command.dml.AlterTableSet;
import org.h14199.command.dml.BackupCommand;
import org.h14199.command.dml.Call;
import org.h14199.command.dml.CommandWithValues;
import org.h14199.command.dml.Delete;
import org.h14199.command.dml.ExecuteProcedure;
import org.h14199.command.dml.Explain;
import org.h14199.command.dml.Insert;
import org.h14199.command.dml.Merge;
import org.h14199.command.dml.MergeUsing;
import org.h14199.command.dml.NoOperation;
import org.h14199.command.dml.Query;
import org.h14199.command.dml.Replace;
import org.h14199.command.dml.RunScriptCommand;
import org.h14199.command.dml.ScriptCommand;
import org.h14199.command.dml.Select;
import org.h14199.command.dml.SelectOrderBy;
import org.h14199.command.dml.SelectUnion;
import org.h14199.command.dml.Set;
import org.h14199.command.dml.SetTypes;
import org.h14199.command.dml.TransactionCommand;
import org.h14199.command.dml.Update;
...
import org.h14199.engine.Domain;
import org.h14199.engine.FunctionAlias;
...
import org.h14199.expression.aggregate.JavaAggregate;
import org.h14199.expression.analysis.DataAnalysisOperation;
import org.h14199.expression.analysis.Window;
import org.h14199.expression.analysis.WindowFrame;
import org.h14199.expression.analysis.WindowFrameBound;
import org.h14199.expression.analysis.WindowFrameBoundType;
import org.h14199.expression.analysis.WindowFrameExclusion;
import org.h14199.expression.analysis.WindowFrameUnits;
import org.h14199.expression.analysis.WindowFunction;
import org.h14199.expression.analysis.WindowFunctionType;
import org.h14199.expression.condition.CompareLike;
import org.h14199.expression.condition.Comparison;
import org.h14199.expression.condition.ConditionAndOr;
import org.h14199.expression.condition.ConditionExists;
import org.h14199.expression.condition.ConditionIn;
import org.h14199.expression.condition.ConditionInParameter;
import org.h14199.expression.condition.ConditionInSelect;
import org.h14199.expression.condition.ConditionNot;
import org.h14199.expression.function.Function;
import org.h14199.expression.function.FunctionCall;
import org.h14199.expression.function.JavaFunction;
...
import org.h14199.table.FunctionTable;
...
import org.h14199.table.TableFilter.TableFilterVisitor;
import org.h14199.util.IntervalUtils;
import org.h14199.util.ParserUtil;
...
import org.h14199.value.ExtTypeInfoEnum;
import org.h14199.value.ExtTypeInfoGeometry;
...
import org.h14199.value.ValueDecimal;
import org.h14199.value.ValueInt;
import org.h14199.value.ValueInterval;
...
public class Parser {
    ...
    /**
     * @see org.h14199.engine.DbSettings#databaseToLower
     */
    private final boolean identifiersToLower;
    /**
     * @see org.h14199.engine.DbSettings#databaseToUpper
     */
