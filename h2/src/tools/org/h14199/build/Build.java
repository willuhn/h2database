...
import org.h14199.build.doc.XMLParser;
...
public class Build extends BuildBase {
    ...
    public void benchmark() {
        ...
        StringList args = args("-Xmx128m",
                "-cp", cp, "org.h14199.test.bench.TestPerformance");
    ...
    private void compileTools() {
        mkdir("temp");
        FileList files = files("src/tools").keep("src/tools/org/h14199/build/*");
    ...
    public void coverage() {
        ...
        execJava(args(
                ...
                "-javaagent:ext/jacocoagent.jar=destfile=coverage/jacoco.exec,"
                        + "excludes=org.h14199.test.*:org.h14199.tools.*:org.h14199.sample.*",
                "-cp", cp,
                "org.h14199.test.TestAll", "codeCoverage"));
        // Remove classes that we don't want to include in report
        delete(files("coverage/bin/org/h14199/test"));
        delete(files("coverage/bin/org/h14199/tools"));
        delete(files("coverage/bin/org/h14199/sample"));
        // Generate report
        execJava(args("-cp",
    ...
    private void compileMVStore(boolean debugInfo) {
        ...
        FileList files;
        files = files("src/main/org/h14199/mvstore").
                exclude("src/main/org/h14199/mvstore/db/*");
    ...
    private void compile(boolean debugInfo, boolean clientOnly,
        ...
        FileList files;
        if (clientOnly) {
            files = files("src/main/org/h14199/Driver.java");
            files.addAll(files("src/main/org/h14199/jdbc"));
            files.addAll(files("src/main/org/h14199/jdbcx"));
        } else {
        ...
        if (!clientOnly) {
            ...
            files = files.exclude("test/org/h14199/test/TestAllJunit.java");
            args = args("-Xlint:unchecked", "-Xlint:deprecation",
                    "-d", "temp", "-sourcepath", "test" + File.pathSeparator + "src/tools",
                    "-classpath", classpath);
            if (version != null) {
                args = args.plus("-target", version, "-source", version);
            }
    ...
    public void docs() {
        ...
        java("org.h14199.build.doc.XMLChecker", null);
        java("org.h14199.build.code.CheckJavadoc", null);
        java("org.h14199.build.code.CheckTextFiles", null);
        java("org.h14199.build.doc.GenerateDoc", null);
        java("org.h14199.build.doc.GenerateHelp", null);
        java("org.h14199.build.i18n.PrepareTranslation", null);
        java("org.h14199.build.indexer.Indexer", null);
        java("org.h14199.build.doc.MergeDocs", null);
        java("org.h14199.build.doc.WebSite", null);
        java("org.h14199.build.doc.LinkChecker", null);
        java("org.h14199.build.doc.XMLChecker", null);
        java("org.h14199.build.doc.SpellChecker", null);
        java("org.h14199.build.code.CheckTextFiles", null);
        beep();
    }
    ...
    private static String getVersion() {
        return getStaticValue("org.h14199.engine.Constants", "getVersion");
    }
    ...
    public void installer() {
        ...
        String buildDate = getStaticField("org.h14199.engine.Constants", "BUILD_DATE");
    ...
    private void addVersions(boolean includeCurrentTimestamp) {
        ...
        if (!includeCurrentTimestamp) {
            delete(files("temp/META-INF/versions/9/org/h14199/util/CurrentTimestamp.class"));
        }
    }
    ...
    public void jar() {
        ...
        FileList files = files("temp").
            exclude("temp/org/h14199/build/*").
            exclude("temp/org/h14199/dev/*").
            exclude("temp/org/h14199/jcr/*").
            exclude("temp/org/h14199/java/*").
            exclude("temp/org/h14199/jcr/*").
            exclude("temp/org/h14199/samples/*").
            exclude("temp/org/h14199/server/ftp/*").
            exclude("temp/org/h14199/test/*").
            exclude("*.bat").
            exclude("*.sh").
            exclude("*.txt").
            exclude("*.DS_Store");
    ...
    public void jarSmall() {
        ...
        FileList files = files("temp").
            ...
            exclude("temp/org/h14199/server/ftp/*").
            exclude("temp/org/h14199/test/*").
            exclude("temp/org/h14199/bnf/*").
            exclude("temp/org/h14199/fulltext/*").
            exclude("temp/org/h14199/jdbcx/*").
            exclude("temp/org/h14199/jmx/*").
            exclude("temp/org/h14199/server/*").
            exclude("temp/org/h14199/tools/*").
            exclude("*.bat").
            exclude("*.sh").
            exclude("*.txt").
            exclude("*.DS_Store");
        files = excludeTestMetaInfFiles(files);
        files.add(new File("temp/org/h14199/tools/DeleteDbFiles.class"));
        files.add(new File("temp/org/h14199/tools/CompressTool.class"));
    ...
    public void javadoc() {
        ...
        delete("docs");
        mkdir("docs/javadoc");
        javadoc("-sourcepath", "src/main", "org.h14199.jdbc", "org.h14199.jdbcx",
                "org.h14199.tools", "org.h14199.api", "org.h14199.engine", "org.h14199.fulltext",
                "-classpath",
                ...
                "-doclet", "org.h14199.build.doclet.Doclet");
    ...
    public void javadocImpl() {
        ...
        javadoc("-sourcepath", "src/main",
                ...
                File.pathSeparator + "ext/org.osgi.enterprise-4.2.0.jar" +
                File.pathSeparator + "ext/jts-core-1.15.0.jar",
                "-subpackages", "org.h14199.mvstore",
                "-exclude", "org.h14199.mvstore.db");
    ...
    public void mavenDeployCentral() {
        ...
        files = files("src/main");
        copy("docs", files, "src/main");
        files = files("docs").keep("docs/org/h14199/mvstore/*").
                exclude("docs/org/h14199/mvstore/db/*").
                keep("*.java");
        files.addAll(files("docs").keep("docs/META-INF/*"));
    ...
    private void resources(boolean clientOnly, boolean basicOnly) {
        if (!clientOnly) {
            java("org.h14199.build.doc.GenerateHelp", null);
            javadoc("-sourcepath", "src/main", "org.h14199.tools", "org.h14199.jmx",
                    "-classpath",
                    "ext/lucene-core-5.5.5.jar" +
                    File.pathSeparator + "ext/lucene-analyzers-common-5.5.5.jar" +
                    File.pathSeparator + "ext/lucene-queryparser-5.5.5.jar" +
                    File.pathSeparator + "ext/jts-core-1.15.0.jar",
                    "-docletpath", "bin" + File.pathSeparator + "temp",
                    "-doclet", "org.h14199.build.doclet.ResourceDoclet");
        }
        FileList files = files("src/main").
            exclude("*.MF").
            exclude("*.java").
            ...
            exclude("*.DS_Store");
        if (basicOnly) {
            files = files.keep("src/main/org/h14199/res/_messages_en.*");
        }
        if (clientOnly) {
            files = files.exclude("src/main/org/h14199/res/help.csv");
            files = files.exclude("src/main/org/h14199/res/h2*");
            files = files.exclude("src/main/org/h14199/res/javadoc.properties");
            files = files.exclude("src/main/org/h14199/server/*");
        }
        zip("temp/org/h14199/util/data.zip", files, "src/main", true, false);
    }
    ...
    private void test(boolean travis) {
        ...
        if (travis) {
            ret = execJava(args(
                    ...
                    "-cp", cp,
                    "org.h14199.test.TestAll", "travis"));
        } else {
            ret = execJava(args(
                    "-ea",
                    "-Xmx128m",
                    "-cp", cp,
                    "org.h14199.test.TestAll"));
        }
    ...
    public void uploadBuild() {
        ...
        execJava(args("-Xmx512m", "-cp", cp,
                ...
                "org.h14199.build.doc.UploadBuild"));
    }
