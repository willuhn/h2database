...
import org.h14199.jdbcx.JdbcDataSource;
...
public class OsgiDataSourceFactory implements DataSourceFactory {
    private final org.h14199.Driver driver;

    public OsgiDataSourceFactory(org.h14199.Driver driver) {
        this.driver = driver;
    }
    ...
    static void registerService(BundleContext bundleContext,
            org.h14199.Driver driver) {
        Properties properties = new Properties();
        properties.put(
                DataSourceFactory.OSGI_JDBC_DRIVER_CLASS,
                org.h14199.Driver.class.getName());
        properties.put(
