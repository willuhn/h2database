...
import org.h14199.Driver;
import org.h14199.engine.Constants;
import org.h14199.store.fs.FilePathRec;
import org.h14199.store.fs.FileUtils;
import org.h14199.test.auth.TestAuthentication;
import org.h14199.test.bench.TestPerformance;
import org.h14199.test.db.TestAlter;
import org.h14199.test.db.TestAlterSchemaRename;
import org.h14199.test.db.TestAnalyzeTableTx;
import org.h14199.test.db.TestAutoRecompile;
import org.h14199.test.db.TestBackup;
import org.h14199.test.db.TestBigDb;
import org.h14199.test.db.TestBigResult;
import org.h14199.test.db.TestCases;
import org.h14199.test.db.TestCheckpoint;
import org.h14199.test.db.TestCluster;
import org.h14199.test.db.TestCompatibility;
import org.h14199.test.db.TestCompatibilityOracle;
import org.h14199.test.db.TestCompatibilitySQLServer;
import org.h14199.test.db.TestCsv;
import org.h14199.test.db.TestDateStorage;
import org.h14199.test.db.TestDeadlock;
import org.h14199.test.db.TestDrop;
import org.h14199.test.db.TestDuplicateKeyUpdate;
import org.h14199.test.db.TestEncryptedDb;
import org.h14199.test.db.TestExclusive;
import org.h14199.test.db.TestFullText;
import org.h14199.test.db.TestFunctionOverload;
import org.h14199.test.db.TestFunctions;
import org.h14199.test.db.TestGeneralCommonTableQueries;
import org.h14199.test.db.TestIndex;
import org.h14199.test.db.TestIndexHints;
import org.h14199.test.db.TestLargeBlob;
import org.h14199.test.db.TestLinkedTable;
import org.h14199.test.db.TestListener;
import org.h14199.test.db.TestLob;
import org.h14199.test.db.TestMemoryUsage;
import org.h14199.test.db.TestMergeUsing;
import org.h14199.test.db.TestMultiConn;
import org.h14199.test.db.TestMultiDimension;
import org.h14199.test.db.TestMultiThread;
import org.h14199.test.db.TestMultiThreadedKernel;
import org.h14199.test.db.TestOpenClose;
import org.h14199.test.db.TestOptimizations;
import org.h14199.test.db.TestOptimizerHints;
import org.h14199.test.db.TestOutOfMemory;
import org.h14199.test.db.TestPersistentCommonTableExpressions;
import org.h14199.test.db.TestPowerOff;
import org.h14199.test.db.TestQueryCache;
import org.h14199.test.db.TestReadOnly;
import org.h14199.test.db.TestRecursiveQueries;
import org.h14199.test.db.TestRights;
import org.h14199.test.db.TestRowFactory;
import org.h14199.test.db.TestRunscript;
import org.h14199.test.db.TestSQLInjection;
import org.h14199.test.db.TestSelectCountNonNullColumn;
import org.h14199.test.db.TestSequence;
import org.h14199.test.db.TestSessionsLocks;
import org.h14199.test.db.TestSetCollation;
import org.h14199.test.db.TestSpaceReuse;
import org.h14199.test.db.TestSpatial;
import org.h14199.test.db.TestSpeed;
import org.h14199.test.db.TestSubqueryPerformanceOnLazyExecutionMode;
import org.h14199.test.db.TestSynonymForTable;
import org.h14199.test.db.TestTableEngines;
import org.h14199.test.db.TestTempTables;
import org.h14199.test.db.TestTransaction;
import org.h14199.test.db.TestTriggersConstraints;
import org.h14199.test.db.TestTwoPhaseCommit;
import org.h14199.test.db.TestUpgrade;
import org.h14199.test.db.TestUsingIndex;
import org.h14199.test.db.TestView;
import org.h14199.test.db.TestViewAlterTable;
import org.h14199.test.db.TestViewDropView;
import org.h14199.test.jdbc.TestBatchUpdates;
import org.h14199.test.jdbc.TestCallableStatement;
import org.h14199.test.jdbc.TestCancel;
import org.h14199.test.jdbc.TestConcurrentConnectionUsage;
import org.h14199.test.jdbc.TestConnection;
import org.h14199.test.jdbc.TestCustomDataTypesHandler;
import org.h14199.test.jdbc.TestDatabaseEventListener;
import org.h14199.test.jdbc.TestDriver;
import org.h14199.test.jdbc.TestGetGeneratedKeys;
import org.h14199.test.jdbc.TestJavaObject;
import org.h14199.test.jdbc.TestJavaObjectSerializer;
import org.h14199.test.jdbc.TestLimitUpdates;
import org.h14199.test.jdbc.TestLobApi;
import org.h14199.test.jdbc.TestManyJdbcObjects;
import org.h14199.test.jdbc.TestMetaData;
import org.h14199.test.jdbc.TestNativeSQL;
import org.h14199.test.jdbc.TestPreparedStatement;
import org.h14199.test.jdbc.TestResultSet;
import org.h14199.test.jdbc.TestSQLXML;
import org.h14199.test.jdbc.TestStatement;
import org.h14199.test.jdbc.TestTransactionIsolation;
import org.h14199.test.jdbc.TestUpdatableResultSet;
import org.h14199.test.jdbc.TestUrlJavaObjectSerializer;
import org.h14199.test.jdbc.TestZloty;
import org.h14199.test.jdbcx.TestConnectionPool;
import org.h14199.test.jdbcx.TestDataSource;
import org.h14199.test.jdbcx.TestXA;
import org.h14199.test.jdbcx.TestXASimple;
import org.h14199.test.mvcc.TestMvcc1;
import org.h14199.test.mvcc.TestMvcc2;
import org.h14199.test.mvcc.TestMvcc3;
import org.h14199.test.mvcc.TestMvcc4;
import org.h14199.test.mvcc.TestMvccMultiThreaded;
import org.h14199.test.mvcc.TestMvccMultiThreaded2;
import org.h14199.test.poweroff.TestReorderWrites;
import org.h14199.test.recover.RecoverLobTest;
import org.h14199.test.rowlock.TestRowLocks;
import org.h14199.test.scripts.TestScript;
import org.h14199.test.server.TestAutoServer;
import org.h14199.test.server.TestInit;
import org.h14199.test.server.TestNestedLoop;
import org.h14199.test.server.TestWeb;
import org.h14199.test.store.TestCacheConcurrentLIRS;
import org.h14199.test.store.TestCacheLIRS;
import org.h14199.test.store.TestCacheLongKeyLIRS;
import org.h14199.test.store.TestConcurrent;
import org.h14199.test.store.TestDataUtils;
import org.h14199.test.store.TestDefrag;
import org.h14199.test.store.TestFreeSpace;
import org.h14199.test.store.TestKillProcessWhileWriting;
import org.h14199.test.store.TestMVRTree;
import org.h14199.test.store.TestMVStore;
import org.h14199.test.store.TestMVStoreBenchmark;
import org.h14199.test.store.TestMVStoreStopCompact;
import org.h14199.test.store.TestMVStoreTool;
import org.h14199.test.store.TestMVTableEngine;
import org.h14199.test.store.TestObjectDataType;
import org.h14199.test.store.TestRandomMapOps;
import org.h14199.test.store.TestSpinLock;
import org.h14199.test.store.TestStreamStore;
import org.h14199.test.store.TestTransactionStore;
import org.h14199.test.synth.TestBtreeIndex;
import org.h14199.test.synth.TestConcurrentUpdate;
import org.h14199.test.synth.TestCrashAPI;
import org.h14199.test.synth.TestDiskFull;
import org.h14199.test.synth.TestFuzzOptimizations;
import org.h14199.test.synth.TestHaltApp;
import org.h14199.test.synth.TestJoin;
import org.h14199.test.synth.TestKill;
import org.h14199.test.synth.TestKillRestart;
import org.h14199.test.synth.TestKillRestartMulti;
import org.h14199.test.synth.TestLimit;
import org.h14199.test.synth.TestMultiThreaded;
import org.h14199.test.synth.TestNestedJoins;
import org.h14199.test.synth.TestOuterJoins;
import org.h14199.test.synth.TestRandomCompare;
import org.h14199.test.synth.TestRandomSQL;
import org.h14199.test.synth.TestStringAggCompatibility;
import org.h14199.test.synth.TestTimer;
import org.h14199.test.synth.sql.TestSynth;
import org.h14199.test.synth.thread.TestMulti;
import org.h14199.test.unit.TestAnsCompression;
import org.h14199.test.unit.TestAutoReconnect;
import org.h14199.test.unit.TestBinaryArithmeticStream;
import org.h14199.test.unit.TestBitStream;
import org.h14199.test.unit.TestBnf;
import org.h14199.test.unit.TestCache;
import org.h14199.test.unit.TestCharsetCollator;
import org.h14199.test.unit.TestClearReferences;
import org.h14199.test.unit.TestCollation;
import org.h14199.test.unit.TestCompress;
import org.h14199.test.unit.TestConnectionInfo;
import org.h14199.test.unit.TestDataPage;
import org.h14199.test.unit.TestDate;
import org.h14199.test.unit.TestDateIso8601;
import org.h14199.test.unit.TestDateTimeUtils;
import org.h14199.test.unit.TestDbException;
import org.h14199.test.unit.TestExit;
import org.h14199.test.unit.TestFile;
import org.h14199.test.unit.TestFileLock;
import org.h14199.test.unit.TestFileLockProcess;
import org.h14199.test.unit.TestFileLockSerialized;
import org.h14199.test.unit.TestFileSystem;
import org.h14199.test.unit.TestFtp;
import org.h14199.test.unit.TestGeometryUtils;
import org.h14199.test.unit.TestIntArray;
import org.h14199.test.unit.TestIntIntHashMap;
import org.h14199.test.unit.TestIntPerfectHash;
import org.h14199.test.unit.TestInterval;
import org.h14199.test.unit.TestJmx;
import org.h14199.test.unit.TestKeywords;
import org.h14199.test.unit.TestLocalResultFactory;
import org.h14199.test.unit.TestLocale;
import org.h14199.test.unit.TestMVTempResult;
import org.h14199.test.unit.TestMathUtils;
import org.h14199.test.unit.TestMemoryUnmapper;
import org.h14199.test.unit.TestMode;
import org.h14199.test.unit.TestModifyOnWrite;
import org.h14199.test.unit.TestNetUtils;
import org.h14199.test.unit.TestObjectDeserialization;
import org.h14199.test.unit.TestOldVersion;
import org.h14199.test.unit.TestOverflow;
import org.h14199.test.unit.TestPageStore;
import org.h14199.test.unit.TestPageStoreCoverage;
import org.h14199.test.unit.TestPattern;
import org.h14199.test.unit.TestPerfectHash;
import org.h14199.test.unit.TestPgServer;
import org.h14199.test.unit.TestReader;
import org.h14199.test.unit.TestRecovery;
import org.h14199.test.unit.TestReopen;
import org.h14199.test.unit.TestSampleApps;
import org.h14199.test.unit.TestScriptReader;
import org.h14199.test.unit.TestSecurity;
import org.h14199.test.unit.TestShell;
import org.h14199.test.unit.TestSort;
import org.h14199.test.unit.TestStreams;
import org.h14199.test.unit.TestStringCache;
import org.h14199.test.unit.TestStringUtils;
import org.h14199.test.unit.TestTimeStampWithTimeZone;
import org.h14199.test.unit.TestTools;
import org.h14199.test.unit.TestTraceSystem;
import org.h14199.test.unit.TestUtils;
import org.h14199.test.unit.TestValue;
import org.h14199.test.unit.TestValueMemory;
import org.h14199.test.utils.OutputCatcher;
import org.h14199.test.utils.SelfDestructor;
import org.h14199.test.utils.TestColumnNamer;
import org.h14199.tools.DeleteDbFiles;
import org.h14199.tools.Server;
import org.h14199.util.AbbaLockingDetector;
import org.h14199.util.Profiler;
import org.h14199.util.StringUtils;
import org.h14199.util.Task;
import org.h14199.util.ThreadDeadlockDetector;
...
--reportDir data --targetClasses org.h14199.dev.store.btree.StreamStore*
--targetTests org.h14199.test.store.TestStreamStore
...
del *.db
start cmd /k "java -cp .;%H2DRIVERS% org.h14199.test.TestAll join >testJoin.txt"
start cmd /k "java -cp . org.h14199.test.TestAll synth >testSynth.txt"
start cmd /k "java -cp . org.h14199.test.TestAll all >testAll.txt"
start cmd /k "java -cp . org.h14199.test.TestAll random >testRandom.txt"
start cmd /k "java -cp . org.h14199.test.TestAll btree >testBtree.txt"
start cmd /k "java -cp . org.h14199.test.TestAll halt >testHalt.txt"
java -cp . org.h14199.test.TestAll crash >testCrash.txt

java org.h14199.test.TestAll timer
...
reopen org.h14199.test.unit.TestPageStore
...
kill a test:
kill -9 `jps -l | grep "org.h14199.test." | cut -d " " -f 1`
...
*/
    ...
    private void testAdditional() {
        ...
        addTest(createTest("org.h14199.test.unit.TestServlet"));
