...
import org.h14199.tools.SimpleResultSet.SimpleArray;
...
public class TestTools extends TestDb {
    ...
    private void testJdbcDriverUtils() {
        assertEquals("org.h14199.Driver", JdbcUtils.getDriver("jdbc:h2:~/test"));
        ...
        try {
            JdbcUtils.getConnection("org.h14199.Driver", "jdbc:h2x:test", "sa", "");
